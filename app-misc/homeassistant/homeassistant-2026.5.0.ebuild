...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.5.0/work/core-2026.5.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/ulid-transform-2.2.0
	>=dev-python/urllib3-2.0
	>=dev-python/uv-0.11.8

	~dev-python/voluptuous-openapi-0.3.0
...
RDEPEND="${RDEPEND}
	...
	acer-projector? ( ~dev-python/serialx-1.7.0 )
	actron-air? ( ~dev-python/actron-neo-api-0.5.6 )
	...
	alexa-devices? ( ~dev-python/aioamazondevices-13.4.3 )
	...
	anglian-water? ( ~dev-python/pyanglianwater-3.1.2 )
	anova? ( ~dev-python/anova-wifi-0.17.0 )
	anthemav? ( ~dev-python/anthemav-1.4.1 )
	anthropic? ( ~dev-python/anthropic-0.96.0 )
	...
	august? ( ~dev-python/yalexs-ble-3.3.0 ~dev-python/yalexs-9.2.0 )
	...
	bluesound? ( ~dev-python/pyblu-2.0.6 )
	bluetooth? ( ~dev-python/bleak-retry-connector-4.6.0 ~dev-python/bleak-2.1.1 ~dev-python/bluetooth-adapters-2.1.0 ~dev-python/bluetooth-auto-recovery-1.5.3 ~dev-python/bluetooth-data-tools-1.28.4 ~dev-python/dbus-fast-4.0.4 ~dev-python/habluetooth-6.1.0 )
	...
	brother? ( ~dev-python/brother-6.1.0 )
	...
	bsblan? ( ~dev-python/python-bsblan-5.2.0 )
	...
	conversation? ( ~dev-python/hassil-3.5.0 ~dev-python/home-assistant-intents-2026.5.5 )
	...
	duco? ( ~dev-python/python-duco-client-0.3.10 )
	...
	easyenergy? ( ~dev-python/easyenergy-3.0.0 )
	...
	ecovacs? ( ~dev-python/deebot-client-18.2.0 ~dev-python/py-sucks-0.9.11 )
	...
	enphase-envoy? ( ~dev-python/pyenphase-2.4.8 )
	entur-public-transport? ( ~dev-python/enturclient-0.2.4 )
	environment-canada? ( ~dev-python/env-canada-0.13.2 )
	...
	esphome? ( ~dev-python/aioesphomeapi-44.21.0 ~dev-python/bleak-esphome-3.7.3 ~dev-python/esphome-dashboard-api-1.3.0 )
	...
	fluss? ( ~dev-python/fluss-api-0.2.4 )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20260429.3 )
	frontier-silicon? ( ~dev-python/afsapi-1.0.0 )
	...
	gardena-bluetooth? ( ~dev-python/gardena-bluetooth-2.4.0 )
	gc100? ( ~dev-python/python-gc100-1.0.3_alpha0 )
	gdacs? ( ~dev-python/aio-georss-gdacs-0.10 )
	generic? ( ~dev-python/pillow-12.2.0 ~dev-python/av-16.0.1 )
	...
	govee-ble? ( ~dev-python/govee-ble-1.2.0 )
	...
	hassio? ( ~dev-python/aiohasupervisor-0.4.3 )
	...
	holiday? ( ~dev-python/babel-2.15.0 ~dev-python/holidays-0.95 )
	homeassistant-hardware? ( ~dev-python/ha-silabs-firmware-client-0.3.0 ~dev-python/universal-silabs-flasher-1.1.0 )
	home-connect? ( ~dev-python/aiohomeconnect-0.36.0 )
	homee? ( ~dev-python/pyhomee-1.3.8 )
	homekit-controller? ( ~dev-python/aiohomekit-3.2.20 )
	homekit? ( ~dev-python/hap-python-5.0.0 ~dev-python/pyqrcode-1.2.1 ~dev-python/base36-0.1.1 ~dev-python/fnv-hash-fast-2.0.2 ~dev-python/homekit-audio-proxy-1.2.1 )
	homematicip-cloud? ( ~dev-python/homematicip-2.8.0 )
	...
	honeywell-string-lights? ( ~dev-python/rf-protocols-2.2.0 )
	horizon? ( ~dev-python/horimote-0.4.1 )
	hp-ilo? ( ~dev-python/python-hpilo-4.4.3 )
	hr-energy-qube? ( ~dev-python/python-qube-heatpump-1.8.0 )
	...
	husqvarna-automower-ble? ( ~dev-python/automower-ble-0.2.8 ~dev-python/gardena-bluetooth-2.4.0 )
	husqvarna-automower? ( ~dev-python/aioautomower-2.7.4 )
	...
	hypontech? ( ~dev-python/hyponcloud-0.9.3 )
	...
	idasen-desk? ( ~dev-python/idasen-ha-2.6.5 )
	...
	kaleidescape? ( ~dev-python/pykaleidescape-1.1.5 )
	...
	knx? ( ~dev-python/knx-frontend-2026.4.30.60856 ~dev-python/xknx-3.15.0 ~dev-python/xknxproject-3.9.0 )
	...
	led-ble? ( ~dev-python/bluetooth-data-tools-1.28.4 ~dev-python/led-ble-1.1.8 )
	...
	lg-thinq? ( ~dev-python/thinqconnect-1.0.12 )
	libre-hardware-monitor? ( ~dev-python/librehardwaremonitor-api-1.11.1 )
	lichess? ( ~dev-python/aiolichess-1.2.0 )
	...
	litterrobot? ( ~dev-python/pylitterbot-2025.4.0 )
	...
	lunatone? ( ~dev-python/lunatone-rest-api-client-0.9.1 )
	...
	matter? ( ~dev-python/matter-python-client-0.6.0 )
	...
	music-assistant? ( ~dev-python/music-assistant-client-1.3.5 )
	...
	nintendo-parental-controls? ( ~dev-python/pynintendoauth-1.0.2 ~dev-python/pynintendoparental-2.3.4 )
	...
	novy-cooker-hood? ( ~dev-python/rf-protocols-2.2.0 )
	...
	onvif? ( ~dev-python/wsdiscovery-2.1.2 ~dev-python/onvif-zeep-async-4.0.4 ~dev-python/onvif-parsers-2.3.0 )
	openai-conversation? ( ~dev-python/openai-2.21.0 )
	opendisplay? ( ~dev-python/py-opendisplay-5.9.0 )
	openerz? ( ~dev-python/openerz-api-0.3.0 )
	openevse? ( ~dev-python/python-openevse-http-0.2.5 )
	...
	pooldose? ( ~dev-python/python-pooldose-0.9.0 )
	...
	pvpc-hourly-pricing? ( ~dev-python/aiopvpc-4.3.1 )
	...
	qbus? ( ~dev-python/qbusmqttapi-1.4.3 )
	...
	qrcode? ( ~dev-python/pillow-12.2.0 ~dev-python/pyzbar-0.1.7 )
	...
	radio-frequency? ( ~dev-python/rf-protocols-2.2.0 )
	...
	recorder? ( ~dev-python/sqlalchemy-2.0.49 ~dev-python/fnv-hash-fast-2.0.2 ~dev-python/psutil-home-assistant-0.0.1 )
	...
	renault? ( ~dev-python/renault-api-0.5.7 )
	...
	risco? ( ~dev-python/pyrisco-0.6.8 )
	rituals-perfume-genie? ( ~dev-python/pyrituals-0.0.7 )
	rmvtransport? ( ~dev-python/pyrmvtransport-0.3.3 )
	roborock? ( ~dev-python/python-roborock-5.5.1 ~dev-python/vacuum-map-parser-roborock-0.1.4 )
	...
	serial? ( ~dev-python/serialx-1.7.0 )
	...
	shelly? ( ~dev-python/aioshelly-13.25.0 )
	...
	sonos? ( =dev-python/defusedxml-0.7.1-r1 ~dev-python/soco-0.30.15 ~dev-python/sonos-websocket-0.1.3 )
	...
	sql? ( ~dev-python/sqlalchemy-2.0.49 ~dev-python/sqlparse-0.5.5 )
	...
	stream? ( ~dev-python/pyturbojpeg-1.8.3 ~dev-python/av-16.0.1 ~dev-python/numpy-2.3.2 )
	subaru? ( ~dev-python/subarulink-0.7.19 )
	suez-water? ( ~dev-python/pysuezv2-2.0.7 )
	sunricher-dali? ( ~dev-python/pysrdaligateway-0.20.4 )
	...
	switchbot-cloud? ( ~dev-python/switchbot-api-2.11.0 )
	...
	tessie? ( ~dev-python/tesla-fleet-api-1.4.7 ~dev-python/tessie-api-0.1.1 )
	...
	tibber? ( ~dev-python/pytibber-0.37.4 )
	...
	tplink-omada? ( ~dev-python/tplink-omada-client-1.5.7 )
	...
	tuya? ( ~dev-python/tuya-device-handlers-0.0.18 ~dev-python/tuya-device-sharing-sdk-0.2.8 )
	...
	unifi-discovery? ( ~dev-python/unifi-discovery-1.4.0 )
	unifiled? ( ~dev-python/unifiled-0.11 )
	unifi? ( ~dev-python/aiounifi-90 )
	unifiprotect? ( ~dev-python/uiprotect-10.4.1 )
	...
	usb? ( ~dev-python/aiousbwatcher-1.1.2 ~dev-python/serialx-1.7.0 )
	...
	vicare? ( ~dev-python/pyvicare-2.60.1 )
	victron-ble? ( ~dev-python/victron-ble-ha-parser-0.7.0 )
	victron-gx? ( ~dev-python/victron-mqtt-2026.4.17 )
	...
	xiaomi-ble? ( ~dev-python/xiaomi-ble-1.10.1 )
	...
	yale? ( ~dev-python/yalexs-ble-3.3.0 ~dev-python/yalexs-9.2.0 )
	yale-smart-alarm? ( ~dev-python/yalesmartalarmclient-0.4.3 )
	yalexs-ble? ( ~dev-python/yalexs-ble-3.3.0 )
	...
	zwave-js? ( ~dev-python/zwave-js-server-python-0.68.0 )
