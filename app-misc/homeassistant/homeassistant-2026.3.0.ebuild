...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.3.0/work/core-2026.3.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260304.0
...
RDEPEND="${RDEPEND}
	...
	alexa-devices? ( ~dev-python/aioamazondevices-13.0.0 )
	...
	anglian-water? ( ~dev-python/pyanglianwater-3.1.0 )
	...
	august? ( ~dev-python/yalexs-ble-3.2.7 ~dev-python/yalexs-9.2.0 )
	...
	bsblan? ( ~dev-python/python-bsblan-5.1.0 )
	...
	cast? ( ~dev-python/pychromecast-14.0.9 )
	...
	comelit? ( ~dev-python/aiocomelit-2.0.0 )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20260304.0 )
	...
	google? ( ~dev-python/gcal-sync-8.0.0 ~dev-python/ical-13.2.0 ~dev-python/oauth2client-4.1.3 )
	...
	govee-light-local? ( ~dev-python/govee-local-api-2.3.0 )
	...
	jvc-projector? ( ~dev-python/pyjvcprojector-2.0.1 )
	...
	keyboard-remote? ( ~dev-python/asyncinotify-4.2.0 ~dev-python/evohome-async-1.1.3 )
	...
	local-calendar? ( ~dev-python/ical-13.2.0 )
	local-todo? ( ~dev-python/ical-13.2.0 )
	...
	onedrive-for-business? ( ~dev-python/onedrive-personal-sdk-0.1.4 )
	onedrive? ( ~dev-python/onedrive-personal-sdk-0.1.4 )
	...
	otbr? ( ~dev-python/python-otbr-api-2.8.0 )
	...
	portainer? ( ~dev-python/pyportainer-1.0.31 )
	...
	remote-calendar? ( ~dev-python/ical-13.2.0 )
	...
	smartthings? ( ~dev-python/pysmartthings-3.6.0 )
	...
	spotify? ( ~dev-python/spotifyaio-1.0.0 )
	...
	switcher-kis? ( ~dev-python/aioswitcher-6.1.0 )
	...
	teltonika? ( ~dev-python/teltasync-0.1.3 )
	...
	thread? ( ~dev-python/pyroute2-0.7.5 ~dev-python/python-otbr-api-2.8.0 )
	...
	vodafone-station? ( ~dev-python/aiovodafone-3.1.2 )
	...
	yale? ( ~dev-python/yalexs-ble-3.2.7 ~dev-python/yalexs-9.2.0 )
	yale-smart-alarm? ( ~dev-python/yalesmartalarmclient-0.4.3 )
	yalexs-ble? ( ~dev-python/yalexs-ble-3.2.7 )
	...
	zha? ( ~dev-python/serialx-0.6.2 ~dev-python/zha-1.0.1 )
