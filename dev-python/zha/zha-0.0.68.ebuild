...
RDEPEND="
	~dev-python/zigpy-0.82.2[${PYTHON_USEDEP}]
	~dev-python/bellows-0.45.3[${PYTHON_USEDEP}]
	~dev-python/zigpy-znp-0.14.1[${PYTHON_USEDEP}]
	~dev-python/zigpy-deconz-0.25.1[${PYTHON_USEDEP}]
	~dev-python/zigpy-xbee-0.21.0[${PYTHON_USEDEP}]
	~dev-python/zigpy-zigate-0.13.3[${PYTHON_USEDEP}]
	~dev-python/zha-quirks-0.0.143[${PYTHON_USEDEP}]
