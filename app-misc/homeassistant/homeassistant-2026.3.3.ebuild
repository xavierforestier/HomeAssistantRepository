...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.3.3/work/core-2026.3.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	hypontech? ( ~dev-python/hyponcloud-0.9.0 )
	...
	opower? ( ~dev-python/opower-0.17.1 )
