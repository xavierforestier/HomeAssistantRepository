...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.6.0/work/core-2026.6.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	acer-projector? ( ~dev-python/serialx-1.8.0 )
	...
	august? ( ~dev-python/yalexs-ble-3.3.0 ~dev-python/yalexs-9.2.1 )
	...
	blebox? ( ~dev-python/blebox-uniapi-2.5.4 )
	...
	bluetooth? ( ~dev-python/bleak-retry-connector-4.6.1 ~dev-python/bleak-3.0.2 ~dev-python/bluetooth-adapters-2.3.0 ~dev-python/bluetooth-auto-recovery-1.6.4 ~dev-python/bluetooth-data-tools-1.29.18 ~dev-python/dbus-fast-5.0.16 ~dev-python/habluetooth-6.8.1 )
	...
	cambridge-audio? ( ~dev-python/aiostreammagic-2.13.1 )
	...
	ecobee? ( ~dev-python/python-ecobee-api-0.4.0 )
	...
	esphome? ( ~dev-python/aioesphomeapi-45.3.1 ~dev-python/bleak-esphome-3.9.1 ~dev-python/esphome-dashboard-api-1.3.0 )
	...
	google? ( ~dev-python/gcal-sync-8.0.0 ~dev-python/ical-13.2.5 ~dev-python/oauth2client-4.1.3 )
	...
	holiday? ( ~dev-python/babel-2.15.0 ~dev-python/holidays-0.97 )
	...
	homematicip-cloud? ( ~dev-python/homematicip-2.12.0 )
	...
	husqvarna-automower? ( ~dev-python/aioautomower-2.7.5 )
	...
	imgw-pib? ( ~dev-python/imgw-pib-2.2.0 )
	...
	infrared? ( ~dev-python/infrared-protocols-5.6.1 )
	...
	iometer? ( ~dev-python/iometer-1.0.1 )
	...
	knx? ( ~dev-python/knx-frontend-2026.6.1.213802 ~dev-python/xknx-3.15.0 ~dev-python/xknxproject-3.9.0 )
	...
	lamarzocco? ( ~dev-python/pylamarzocco-2.2.5 )
	lametric? ( ~dev-python/demetriek-1.3.0 )
	landisgyr-heat-meter? ( ~dev-python/ultraheat-api-0.6.0 )
	lastfm? ( ~dev-python/pylast-5.1.0 )
	launch-library? ( ~dev-python/pylaunches-2.0.0 )
	laundrify? ( ~dev-python/laundrify-aio-1.2.2 )
	lcn? ( ~dev-python/lcn-frontend-0.2.9 ~dev-python/pypck-0.9.11 )
	...
	local-calendar? ( ~dev-python/ical-13.2.5 )
	local-todo? ( ~dev-python/ical-13.2.5 )
	...
	nintendo-parental-controls? ( ~dev-python/pynintendoauth-1.0.2 ~dev-python/pynintendoparental-2.4.0 )
	...
	onvif? ( ~dev-python/wsdiscovery-2.1.2 ~dev-python/onvif-zeep-async-4.1.1 ~dev-python/onvif-parsers-2.3.0 )
	...
	openevse? ( ~dev-python/python-openevse-http-0.3.4 )
	...
	ouman-eh-800? ( ~dev-python/ouman-eh-800-api-0.5.0 )
	ourgroceries? ( ~dev-python/ourgroceries-1.5.4 )
	overkiz? ( ~dev-python/pyoverkiz-1.20.4 )
	...
	paj-gps? ( ~dev-python/pajgps-api-0.3.1 )
	...
	qbus? ( ~dev-python/qbusmqttapi-1.5.0 )
	...
	recorder? ( ~dev-python/sqlalchemy-2.0.49 ~dev-python/fnv-hash-fast-2.0.3 ~dev-python/psutil-home-assistant-0.0.1 )
	...
	risco? ( ~dev-python/pyrisco-0.7.0 )
	...
	serial? ( ~dev-python/serialx-1.8.0 )
	...
	shelly? ( ~dev-python/aioshelly-13.26.1 )
	...
	smartthings? ( ~dev-python/pysmartthings-4.0.0 )
	...
	sonos? ( =dev-python/defusedxml-0.7.1-r1 ~dev-python/soco-0.31.1 ~dev-python/sonos-websocket-0.1.3 )
	...
	teltonika? ( ~dev-python/teltasync-0.3.1 )
	...
	tuya? ( ~dev-python/tuya-device-handlers-0.0.22 ~dev-python/tuya-device-sharing-sdk-0.2.8 )
	...
	unifiprotect? ( ~dev-python/uiprotect-10.5.0 )
	...
	usb? ( ~dev-python/aiousbwatcher-1.1.2 ~dev-python/serialx-1.8.0 )
	...
	wmspro? ( ~dev-python/pywmspro-0.3.5 )
	wolflink? ( ~dev-python/wolf-comm-0.0.48 )
	workday? ( ~dev-python/holidays-0.97 )
	...
	yale? ( ~dev-python/yalexs-ble-3.3.0 ~dev-python/yalexs-9.2.1 )
	...
	yoto? ( ~dev-python/yoto-api-3.1.5 )
