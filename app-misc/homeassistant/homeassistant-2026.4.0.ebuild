...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.4.0/work/core-2026.4.0/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	alexa-devices? ( ~dev-python/aioamazondevices-13.3.2 )
	...
	bluetooth? ( ~dev-python/bleak-retry-connector-4.6.0 ~dev-python/bleak-2.1.1 ~dev-python/bluetooth-adapters-2.1.0 ~dev-python/bluetooth-auto-recovery-1.5.3 ~dev-python/bluetooth-data-tools-1.28.4 ~dev-python/dbus-fast-3.1.2 ~dev-python/habluetooth-5.11.1 )
	...
	bsblan? ( ~dev-python/python-bsblan-5.1.3 )
	...
	casper-glow? ( ~dev-python/pycasperglow-1.1.0 )
	...
	conversation? ( ~dev-python/hassil-3.5.0 ~dev-python/home-assistant-intents-2026.3.24 )
	...
	ecovacs? ( ~dev-python/deebot-client-18.1.0 ~dev-python/py-sucks-0.9.11 )
	...
	emulated-kasa? ( ~dev-python/sense-energy-0.14.0 )
	...
	enphase-envoy? ( ~dev-python/pyenphase-2.4.6 )
	...
	esphome? ( ~dev-python/aioesphomeapi-44.6.2 ~dev-python/bleak-esphome-3.7.1 ~dev-python/esphome-dashboard-api-1.3.0 )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20260325.5 )
	...
	gardena-bluetooth? ( ~dev-python/gardena-bluetooth-2.1.0 )
	...
	homeassistant-hardware? ( ~dev-python/ha-silabs-firmware-client-0.3.0 ~dev-python/serialx-0.6.2 ~dev-python/universal-silabs-flasher-1.0.3 )
	home-connect? ( ~dev-python/aiohomeconnect-0.33.0 )
	homee? ( ~dev-python/pyhomee-1.3.8 )
	homekit-controller? ( ~dev-python/aiohomekit-3.2.20 )
	homekit? ( ~dev-python/hap-python-5.0.0 ~dev-python/pyqrcode-1.2.1 ~dev-python/base36-0.1.1 ~dev-python/fnv-hash-fast-2.0.0 ~dev-python/homekit-audio-proxy-1.2.1 )
	homematicip-cloud? ( ~dev-python/homematicip-2.7.0 )
	...
	hr-energy-qube? ( ~dev-python/python-qube-heatpump-1.7.0 )
	...
	husqvarna-automower-ble? ( ~dev-python/automower-ble-0.2.8 ~dev-python/gardena-bluetooth-2.1.0 )
	husqvarna-automower? ( ~dev-python/aioautomower-2.7.3 )
	huum? ( ~dev-python/huum-0.8.2 )
	hvv-departures? ( ~dev-python/pygti-0.9.4 )
	hydrawise? ( ~dev-python/pydrawise-2026.3.0 )
	...
	immich? ( ~dev-python/aioimmich-0.12.1 )
	...
	infrared? ( ~dev-python/infrared-protocols-1.1.0 )
	...
	keyboard-remote? ( ~dev-python/asyncinotify-4.4.0 ~dev-python/evohome-async-1.2.0 )
	...
	knx? ( ~dev-python/knx-frontend-2026.3.28.223133 ~dev-python/xknx-3.15.0 ~dev-python/xknxproject-3.8.2 )
	...
	litterrobot? ( ~dev-python/pylitterbot-2025.2.0 )
	...
	lutron-caseta? ( ~dev-python/pylutron-caseta-0.27.0 )
	lutron? ( ~dev-python/pylutron-0.4.0 )
	...
	mealie? ( ~dev-python/aiomealie-1.2.2 )
	...
	nintendo-parental-controls? ( ~dev-python/pynintendoauth-1.0.2 ~dev-python/pynintendoparental-2.3.3 )
	...
	opendisplay? ( ~dev-python/py-opendisplay-5.5.0 )
	...
	opower? ( ~dev-python/opower-0.18.0 )
	...
	pyload? ( ~dev-python/pyloadapi-2.0.0 )
	...
	rainbird? ( ~dev-python/pyrainbird-6.1.1 )
	...
	recorder? ( ~dev-python/sqlalchemy-2.0.41 ~dev-python/fnv-hash-fast-2.0.0 ~dev-python/psutil-home-assistant-0.0.1 )
	...
	roborock? ( ~dev-python/python-roborock-5.0.0 ~dev-python/vacuum-map-parser-roborock-0.1.4 )
	...
	russound-rio? ( ~dev-python/aiorussound-4.9.1 )
	...
	satel-integra? ( ~dev-python/satel-integra-1.0.0 )
	...
	sense? ( ~dev-python/sense-energy-0.14.0 )
	...
	seventeentrack? ( ~dev-python/pyseventeentrack-1.1.2 )
	...
	switchbot? ( ~dev-python/pyswitchbot-2.0.0 )
	...
	telegram-bot? ( ~dev-python/python-telegram-bot-22.6[socks] )
	...
	tesla-fleet? ( ~dev-python/tesla-fleet-api-1.4.5 )
	tesla-wall-connector? ( ~dev-python/tesla-wall-connector-1.1.0 )
	teslemetry? ( ~dev-python/tesla-fleet-api-1.4.5 ~dev-python/teslemetry-stream-0.9.0 )
	tessie? ( ~dev-python/tesla-fleet-api-1.4.5 ~dev-python/tessie-api-0.1.1 )
	...
	tractive? ( ~dev-python/aiotractive-1.0.1 )
	...
	tuya? ( ~dev-python/tuya-device-handlers-0.0.15 ~dev-python/tuya-device-sharing-sdk-0.2.8 )
	...
	unifi-access? ( ~dev-python/py-unifi-access-1.1.3 )
	unifi-direct? ( ~dev-python/unifi-ap-0.0.2 )
	unifiled? ( ~dev-python/unifiled-0.11 )
	unifi? ( ~dev-python/aiounifi-88 )
	unifiprotect? ( ~dev-python/uiprotect-10.2.3 ~dev-python/unifi-discovery-1.2.0 )
	...
	vicare? ( ~dev-python/pyvicare-2.58.1 )
	victron-ble? ( ~dev-python/victron-ble-ha-parser-0.6.3 )
	...
	waterfurnace? ( ~dev-python/waterfurnace-1.6.2 )
	...
	zha? ( ~dev-python/serialx-0.6.2 ~dev-python/zha-1.1.1 )
