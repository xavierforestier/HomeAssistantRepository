...
SRC_URI="https://github.com/node-red/node-red/archive/refs/tags/${PV}.tar.gz  -> ${P}.tar.gz https://github.com/xavierforestier/node-red/releases/download/v${PV}/${P}-nodes_modules.tar.xz"
