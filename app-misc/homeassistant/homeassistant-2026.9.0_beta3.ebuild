...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.9.0_beta3/work/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/bluetooth-data-tools-1.29.21
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-retry-connector-4.6.3 ~dev-python/bleak-3.0.2 ~dev-python/bluetooth-adapters-2.4.0 ~dev-python/bluetooth-auto-recovery-1.6.4 ~dev-python/bluetooth-data-tools-1.29.21 ~dev-python/dbus-fast-5.0.22 ~dev-python/habluetooth-6.26.7 )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20260826.1 )
	...
	growatt-server? ( ~dev-python/growattserver-2.2.0 )
	gtfs? ( ~dev-python/pygtfs-0.1.11 )
	guardian? ( ~dev-python/aioguardian-2026.1.1 )
	guntamatic? ( ~dev-python/guntamatic-1.12.0 )
	...
	ld2410-ble? ( ~dev-python/bluetooth-data-tools-1.29.21 ~dev-python/ld2410-ble-0.1.1 )
	leaone? ( ~dev-python/leaone-ble-0.3.0 )
	led-ble? ( ~dev-python/bluetooth-data-tools-1.29.21 ~dev-python/led-ble-1.1.11 )
	...
	midea? ( ~dev-python/midea-local-10.0.1 )
	...
	music-assistant? ( ~dev-python/music-assistant-client-1.5.1 )
	...
	nad? ( ~dev-python/nad-receiver-0.4.0 )
	nam? ( ~dev-python/nettigo-air-monitor-5.1.0 )
	...
	netio? ( ~dev-python/netio-2.0.1 ~dev-python/pynetio-0.1.9.1 )
	...
	peblar? ( ~dev-python/peblar-0.6.0 )
	...
	private-ble-device? ( ~dev-python/bluetooth-data-tools-1.29.21 )
	...
	reolink? ( ~dev-python/reolink-aio-0.21.13 )
	...
	russound-rio? ( ~dev-python/aiorussound-5.0.2 )
	russound-rnet? ( ~dev-python/aiorussound-5.0.2 )
	...
	somfy-mylink? ( ~dev-python/pysomfymylink-1.0.0 )
	sonarr? ( ~dev-python/aiopyarr-23.4.0 )
	songpal? ( ~dev-python/python-songpal-0.16.2 )
	sonos? ( =dev-python/defusedxml-0.7.1-r1 ~dev-python/soco-0.31.2 ~dev-python/sonos-websocket-0.2.0 )
	...
	togrill? ( ~dev-python/togrill-bluetooth-0.9.0 )
	...
	tuya? ( ~dev-python/tuya-device-handlers-0.0.26 ~dev-python/tuya-device-sharing-sdk-0.2.15 )
	...
	vallox? ( ~dev-python/vallox-websocket-api-6.1.0 )
	...
	wiim? ( ~dev-python/async-upnp-client-0.48.1 ~dev-python/wiim-0.1.6 )
	...
	yale? ( ~dev-python/yalexs-ble-4.0.1 ~dev-python/yalexs-9.2.13 )
	yale-smart-alarm? ( ~dev-python/yalesmartalarmclient-0.4.3 )
	yalexs-ble? ( ~dev-python/yalexs-ble-4.0.1 )
	...
	zha? ( ~dev-python/zha-quirks-2.2.1 ~dev-python/zha-2.2.0 )
