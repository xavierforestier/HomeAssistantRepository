...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.3.1/work/core-2026.3.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	onedrive-for-business? ( ~dev-python/onedrive-personal-sdk-0.1.5 )
	onedrive? ( ~dev-python/onedrive-personal-sdk-0.1.5 )
