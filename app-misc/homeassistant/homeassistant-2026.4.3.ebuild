...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.4.3/work/core-2026.4.3/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	alexa-devices? ( ~dev-python/aioamazondevices-13.4.1 )
	...
	imgw-pib? ( ~dev-python/imgw-pib-2.1.0 )
	...
	litterrobot? ( ~dev-python/pylitterbot-2025.3.2 )
	...
	satel-integra? ( ~dev-python/satel-integra-1.2.1 )
	...
	switchbot? ( ~dev-python/pyswitchbot-2.0.1 )
	...
	tibber? ( ~dev-python/pytibber-0.37.1 )
	...
	vicare? ( ~dev-python/pyvicare-2.59.0 )
