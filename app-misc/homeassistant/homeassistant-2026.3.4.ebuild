...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.3.4/work/core-2026.3.4/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
	...
	~dev-python/home-assistant-frontend-20260312.1
...
RDEPEND="${RDEPEND}
	...
	frontend? ( ~dev-python/home-assistant-frontend-20260312.1 )
	...
	tedee? ( ~dev-python/aiotedee-0.2.27 )
	...
	tplink-omada? ( ~dev-python/tplink-omada-client-1.5.6 )
	...
	wolflink? ( ~dev-python/wolf-comm-0.0.48 )
	...
	xiaomi-ble? ( ~dev-python/xiaomi-ble-1.10.0 )
	...
	yolink? ( ~dev-python/yolink-api-0.6.3 )
