...
# Home Assistant Core dependencies from /var/tmp/portage/app-misc/homeassistant-2026.7.1/work/core-2026.7.1/homeassistant/package_constraints.txt
RDEPEND="${RDEPEND}
...
RDEPEND="${RDEPEND}
	...
	bluetooth? ( ~dev-python/bleak-retry-connector-4.6.1 ~dev-python/bleak-3.0.2 ~dev-python/bluetooth-adapters-2.4.0 ~dev-python/bluetooth-auto-recovery-1.6.4 ~dev-python/bluetooth-data-tools-1.29.18 ~dev-python/dbus-fast-5.0.22 ~dev-python/habluetooth-6.26.2 )
	...
	frontend? ( ~dev-python/home-assistant-frontend-20260624.4 )
	...
	lamarzocco? ( ~dev-python/pylamarzocco-2.4.1 )
	...
	synology-dsm? ( ~dev-python/py-synologydsm-api-2.10.2 )
