...
RDEPEND="$( python_gen_cond_dep '
	...
	>=dev-python/aioesphomeapi-46.3.0[${PYTHON_USEDEP}]
	>=dev-python/aiohappyeyeballs-2.7.1[${PYTHON_USEDEP}]
	>=dev-python/zeroconf-0.151.1[${PYTHON_USEDEP}]
	...
	>=dev-python/platformdirs-4.11.5[${PYTHON_USEDEP}]
	>=dev-build/ninja-1.13.0
	>=dev-python/filelock-3.32.4[${PYTHON_USEDEP}]
