...
RDEPEND="
	~dev-python/zigpy-0.83.0[${PYTHON_USEDEP}]
	~dev-python/bellows-0.46.0[${PYTHON_USEDEP}]
	~dev-python/zigpy-znp-0.14.1[${PYTHON_USEDEP}]
	~dev-python/zigpy-deconz-0.25.2[${PYTHON_USEDEP}]
	~dev-python/zigpy-xbee-0.21.0[${PYTHON_USEDEP}]
	~dev-python/zigpy-zigate-0.13.3[${PYTHON_USEDEP}]
	~dev-python/zha-quirks-0.0.145[${PYTHON_USEDEP}]
